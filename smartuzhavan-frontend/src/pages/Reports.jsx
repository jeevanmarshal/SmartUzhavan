...
const Reports = () => {
  ...
  const handlePDF = async () => {
    ...
    const endpointMap = {
      ...
      driver: 'driver-payroll',
      season: 'seasonal-report'
    };
    try {
      const response = await fetch(`${url}/reports/${endpointMap[reportType]}`, {
        method: 'POST',
      ...
      a.download = `report_${reportType}.pdf`;
      a.click();
    } catch(err) {
  ...
  return (
    <div className="app-container">
      ...
      <div className="card" style={{ marginBottom: '20px' }}>
        <div style={{ display: 'flex', gap: '10px', overflowX: 'auto', paddingBottom: '10px', justifyContent: 'space-between', alignItems: 'center' }}>
          ...
          <Button onClick={handlePDF} variant="outline" style={{ whiteSpace: 'nowrap' }}>Download PDF</Button>
        </div>
      </div>
